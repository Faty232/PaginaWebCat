    ...
    export default {
        ...
        methods: {
            ...
            guardar(){
                axios({
                    method: 'post',
                    url: `${import.meta.env.VITE_RUTA_DB}/pedidoClie`,
                    data: this.form
                }).then( resp => {
            ...
            editar(){
                axios({
                    method: 'put',
                    url: `${import.meta.env.VITE_RUTA_DB}/pedidoClie/${this.$route.params.id}`,
                    data: this.form
                }).then( resp => {
                     console.log(resp);
                    alert(resp.data.message)
         ...
         getDistribuidores(){
            axios({
                method: 'get',
                url: `${import.meta.env.VITE_RUTA_DB}/distribuidor`
            }).then( resp => {
